...
if object_id('temple1') is not null
  drop table temple1;
if object_id('tdepar2') is not null
  drop table tdepar2;
...
--SET DATESTYLE TO 'European' --PostgreSQL
set dateformat dmy
...
INSERT INTO temple1 ( nuempl, nombre, inicial, apellido, dept, tlfn, feching, codtra, niveduc, sexo, fechnac, salario )
	VALUES	( 10, 'CRISTINA', 'I', 'HERNANDEZ', 'A00', 2070, '01.01.1965', 66, 18, 'M', '14.08.1933', 5275 ),
		...
		( 999, 'ANGEL', 'E', 'MALDONADO', 'E11', 0, '22.03.1988', 69, 20, 'H', '12.11.1965', 7500 );
